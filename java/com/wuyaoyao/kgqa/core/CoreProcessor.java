package com.wuyaoyao.kgqa.core;
...
public class CoreProcessor {
    ...
    public  String queryAbstract(String querySentence) {
        ...
        for (Term term : terms) {
            ...
            if (termStr.contains("nm")) {        //nm 疾病名
                abstractQuery += "nm ";
                abstractMap.put("nm", word);
            } else if (termStr.contains("nr")) { //nr 食物名
                abstractQuery += "nr ";
                abstractMap.put("nr", word);
            } else if (termStr.contains("nc")) {  //nc 检查
                abstractQuery += "nc ";
                abstractMap.put("nc", word);
            } else if (termStr.contains("ng")) { //ng 药品
                abstractQuery += "ng ";
                abstractMap.put("ng", word);
            } else if (termStr.contains("vi")) { //ng 药品
                abstractMap.put("vi", word);
                abstractQuery += "vi ";
            } else {
                abstractQuery += word + " ";
            }
    ...
    public String sentenceReduction(String queryPattern) {
        ...
        for (String key : set) {
            ...
            if(key == "vi"){
                String value = abstractMap.get(key);
                queryPattern = queryPattern.replace("nm", value);
            }
        }
